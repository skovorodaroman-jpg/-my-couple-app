...
function DateIdeasPage() {
  const dates = [
    // 🏠 ВДОМА — 30
    {
      title: "🌹 Вечір зі свічками",
      description: "Запаліть свічки, увімкніть романтичну музику, приготуйте напої та проведіть вечір в обіймах.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎬 Домашній кінотеатр",
      description: "Плед, подушки, попкорн і фільм, який ви давно хотіли подивитися разом.",
      place: "Вдома",
      mood: "Затишне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🍕 Піца та фільм",
      description: "Замовте улюблену піцу, виберіть фільм і влаштуйте затишний вечір.",
      place: "Вдома",
      mood: "Веселе",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    {
      title: "🍓 Полуниця в шоколаді",
      description: "Разом приготуйте полуницю в шоколаді та влаштуйте маленьке романтичне побачення.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍳 Готуємо вечерю разом",
      description: "Виберіть нову страву та приготуйте її удвох.",
      place: "Вдома",
      mood: "Веселе",
      budget: "300–600 грн",
      duration: "2–3 години"
    },
    {
      ...
      description: "Спечіть разом печиво, кекс або торт, а потім влаштуйте дегустацію.",
      place: "Вдома",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "💌 20 любовних записок",
      description: "Напишіть одне одному по 10 маленьких любовних записок та читайте їх по черзі.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    },
    {
      ...
      description: "Оберіть кілька настільних ігор та влаштуйте маленький турнір для двох.",
      place: "Вдома",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🧸 Вечір обіймів",
      description: "Приглушене світло, плед, музика та максимальна кількість обіймів.",
      place: "Вдома",
      mood: "Затишне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "📸 Домашня фотосесія",
      description: "Зробіть кумедні, романтичні та милі фотографії одне одного.",
      place: "Вдома",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🎵 Наш музичний вечір",
      description: "По черзі вмикайте пісні, які нагадують вам про ваші моменти.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "💭 Мріємо про майбутнє",
      description: "Сядьте разом і напишіть список мрій, які хочете здійснити удвох.",
      place: "Вдома",
      mood: "Спокійне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍿 Марафон фільмів",
      description: "Оберіть три фільми та зробіть справжній домашній кіномарафон.",
      place: "Вдома",
      mood: "Затишне",
      budget: "До 300 грн",
      duration: "3+ години"
    ...
    {
      title: "🥞 Сніданок на вечерю",
      description: "Приготуйте разом млинці, омлет або інший сніданок, але ввечері.",
      place: "Вдома",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "💍 Побачення мрії",
      description: "Уявіть, що у вас необмежений бюджет, і сплануйте ідеальне побачення.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "📝 Наші 50 спогадів",
      description: "Запишіть 50 найкращих моментів, які пережили разом.",
      place: "Вдома",
      mood: "Спокійне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🎨 Малюємо одне одного",
      description: "Візьміть папір та фарби й спробуйте намалювати портрет одне одного.",
      place: "Вдома",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "💐 Робимо маленький букет",
      description: "Разом складіть красивий букет із доступних квітів.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍫 Шоколадна дегустація",
      description: "Купіть кілька видів шоколаду та оцініть їх разом.",
      place: "Вдома",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "📖 Читаємо разом",
      description: "Оберіть книгу або цікаві історії та проведіть тихий вечір поруч.",
      place: "Вдома",
      mood: "Спокійне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🕯️ Вечеря при свічках",
      description: "Приготуйте або замовте вечерю, вимкніть основне світло та залиште тільки свічки.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎤 Караоке для двох",
      description: "Увімкніть караоке та співайте улюблені пісні разом.",
      place: "Вдома",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🧩 Збираємо пазл",
      description: "Виберіть великий пазл і спробуйте разом скласти його за один вечір.",
      place: "Вдома",
      mood: "Спокійне",
      budget: "300–600 грн",
      duration: "3+ години"
    },
    {
      ...
      description: "Кожен готує для іншого маленький сюрприз, про який партнер не знає.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍹 Готуємо домашні напої",
      description: "Придумайте власні безалкогольні коктейлі та дайте їм романтичні назви.",
      place: "Вдома",
      mood: "Веселе",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "💗 День компліментів",
      description: "По черзі говоріть одне одному компліменти та згадуйте, за що цінуєте партнера.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "📱 Створюємо спільне відео",
      description: "Зніміть маленьке відео про ваші стосунки та ваші найкращі моменти.",
      place: "Вдома",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🌌 Вечір спогадів",
      description: "Передивіться старі фотографії та відео й розкажіть, що відчували в ті моменти.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "❤️ Пишемо листи майбутнім собі",
      description: "Напишіть листи, які відкриєте через рік.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🛋️ Повільний недільний вечір",
      description: "Ніяких планів: плед, смаколики, фільм і просто бути разом.",
      place: "Вдома",
      mood: "Затишне",
      budget: "До 300 грн",
      duration: "3+ години"
    ...
    // 🌆 ВУЛИЦЯ — 25
    {
      title: "🌅 Прогулянка на заході сонця",
      description: "Знайдіть красиве місце та разом подивіться на захід сонця.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🌙 Нічна прогулянка",
      description: "Прогуляйтеся вечірнім містом, тримаючись за руки.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "📸 Фотопрогулянка",
      description: "Гуляйте містом і фотографуйте красиві моменти вашого побачення.",
      place: "На вулиці",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🍦 Морозиво удвох",
      description: "Купіть морозиво та вирушайте на довгу прогулянку.",
      place: "На вулиці",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "1–2 години"
    },
    {
      ...
      description: "Проведіть кілька годин у парку, розмовляючи та відпочиваючи разом.",
      place: "На вулиці",
      mood: "Спокійне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "☔ Побачення під дощем",
      description: "Візьміть одну парасольку на двох і прогуляйтеся, якщо погода дозволяє.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🚶‍♂️ Прогулянка без маршруту",
      description: "Ідіть туди, куди хочеться, без заздалегідь визначеного маршруту.",
      place: "На вулиці",
      mood: "Пригодницьке",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🌸 Шукаємо найкрасивіше місце",
      description: "Влаштуйте маленький квест і знайдіть найромантичніше місце у вашому місті.",
      place: "На вулиці",
      mood: "Пригодницьке",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🥤 Напій на прогулянці",
      description: "Купіть улюблені напої та гуляйте містом, розмовляючи про все на світі.",
      place: "На вулиці",
      mood: "Затишне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🎈 Повітряна кулька-сюрприз",
      description: "Подаруйте одне одному маленьку повітряну кульку та зробіть милі фото.",
      place: "На вулиці",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🗺️ Побачення за жеребом",
      description: "Напишіть кілька місць на папірцях та випадково оберіть, куди підете.",
      place: "На вулиці",
      mood: "Пригодницьке",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    {
      title: "🌆 Вечірній центр міста",
      description: "Красиво одягніться та вирушайте разом гуляти вечірнім містом.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    {
      title: "📷 Полювання за фото",
      description: "Складіть список із 10 фото, які повинні зробити разом за час прогулянки.",
      place: "На вулиці",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🍫 Смаколики на лавочці",
      description: "Купіть улюблені солодощі та влаштуйте маленький перекус просто неба.",
      place: "На вулиці",
      mood: "Затишне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "💌 Сховати любовну записку",
      description: "Заздалегідь сховайте маленьку записку та запропонуйте партнеру її знайти.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🚶 Довга прогулянка удвох",
      description: "Пройдіть кілька кілометрів разом, слухаючи музику та розмовляючи.",
      place: "На вулиці",
      mood: "Спокійне",
      budget: "До 300 грн",
      duration: "3+ години"
    ...
    {
      title: "🌤️ Ранкова прогулянка",
      description: "Прокиньтеся раніше та разом вийдіть на ранкову прогулянку.",
      place: "На вулиці",
      mood: "Спокійне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🌳 Міні-пікнік",
      description: "Візьміть плед, фрукти та напої й влаштуйте невеликий пікнік.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎨 Вулична фотосесія",
      description: "Знайдіть красиві локації та зробіть спільну фотосесію.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    {
      title: "🌃 Місто після заходу",
      description: "Подивіться, як змінюється місто після заходу сонця.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "🧭 Маленька пригода",
      description: "Виберіть місце, де ще ніколи разом не були, та вирушайте туди.",
      place: "На вулиці",
      mood: "Пригодницьке",
      budget: "300–600 грн",
      duration: "3+ години"
    ...
    {
      title: "🌷 Квіти для коханої",
      description: "Купіть красиву квітку та подаруйте її під час прогулянки.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🧃 Лимонад на двох",
      description: "Купіть прохолодний напій і знайдіть затишне місце для розмов.",
      place: "На вулиці",
      mood: "Затишне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🎯 Вуличний челендж",
      description: "Придумайте 5 маленьких завдань одне для одного та виконайте їх під час прогулянки.",
      place: "На вулиці",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "❤️ Прогулянка спогадів",
      description: "Пройдіть місцями, які мають особливе значення для ваших стосунків.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "☕ Кава для двох",
      description: "Знайдіть затишну кав'ярню та проведіть час за розмовами.",
      place: "Кав'ярня",
      mood: "Затишне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍰 Десертне побачення",
      description: "Замовте два десерти та спробуйте вгадати, який сподобається більше.",
      place: "Кав'ярня",
      mood: "Веселе",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍕 Ресторан тільки для вас",
      description: "Виберіть ресторан, де ви ще не були, та спробуйте щось нове.",
      place: "Кав'ярня",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🥐 Ранкове кафе",
      description: "Почніть день зі смачного сніданку в затишному місці.",
      place: "Кав'ярня",
      mood: "Затишне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍨 Морозиво в кафе",
      description: "Оберіть незвичайні смаки морозива та спробуйте їх разом.",
      place: "Кав'ярня",
      mood: "Веселе",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "🫖 Чайне побачення",
      description: "Замовте різні чаї та проведіть тихий вечір у розмовах.",
      place: "Кав'ярня",
      mood: "Спокійне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍔 Обираємо страву навмання",
      description: "Відкрийте меню та кожен навмання оберіть страву для іншого.",
      place: "Кав'ярня",
      mood: "Веселе",
      budget: "600–1000 грн",
      duration: "2–3 години"
    },
    {
      ...
      description: "Красиво одягніться та влаштуйте особливу вечерю удвох.",
      place: "Кав'ярня",
      mood: "Романтичне",
      budget: "1000+ грн",
      duration: "2–3 години"
    ...
    {
      title: "🍹 Напої та розмови",
      description: "Виберіть красиве місце та присвятіть вечір довгим розмовам.",
      place: "Кав'ярня",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🧁 Кафе з рейтингом",
      description: "Знайдіть кафе, де ще не були, і разом оцініть його за власними критеріями.",
      place: "Кав'ярня",
      mood: "Пригодницьке",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🍓 Дегустація десертів",
      description: "Замовте кілька різних десертів та діліться ними між собою.",
      place: "Кав'ярня",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "1–2 години"
    ...
    {
      title: "🥞 Сніданок удвох",
      description: "Зустріньтеся в кафе на сніданок і почніть день разом.",
      place: "Кав'ярня",
      mood: "Затишне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🍵 Нове кафе",
      description: "Оберіть кав'ярню, де ви ніколи не були.",
      place: "Кав'ярня",
      mood: "Пригодницьке",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "💗 Побачення з компліментами",
      description: "Під час вечері кожен говорить партнеру 10 речей, які в ньому любить.",
      place: "Кав'ярня",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎂 Особливий десерт",
      description: "Замовте великий десерт на двох та зробіть з цього маленьке свято.",
      place: "Кав'ярня",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "1–2 години"
    ...
    {
      title: "🎳 Боулінг удвох",
      description: "Пограйте в боулінг та влаштуйте маленьке змагання.",
      place: "Розваги",
      mood: "Веселе",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎱 Більярд",
      description: "Проведіть вечір за більярдом і визначте, хто сьогодні чемпіон.",
      place: "Розваги",
      mood: "Веселе",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎮 Ігровий вечір",
      description: "Пограйте разом у відеоігри або відвідайте ігровий простір.",
      place: "Розваги",
      mood: "Веселе",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎯 Аркадні автомати",
      description: "Влаштуйте змагання в різних аркадних іграх.",
      place: "Розваги",
      mood: "Веселе",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🧩 Квест-кімната",
      description: "Разом спробуйте вибратися з квест-кімнати та перевірте, наскільки добре ви працюєте в команді.",
      place: "Розваги",
      mood: "Пригодницьке",
      budget: "1000+ грн",
      duration: "2–3 години"
    ...
    {
      title: "🎡 Атракціони",
      description: "Проведіть вечір на атракціонах і поверніться хоча б ненадовго в дитинство.",
      place: "Розваги",
      mood: "Веселе",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎤 Караоке-клуб",
      description: "Заспівайте разом улюблені пісні та не соромтеся бути смішними.",
      place: "Розваги",
      mood: "Веселе",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎨 Майстер-клас",
      description: "Спробуйте разом нове заняття: малювання, кераміку або іншу творчість.",
      place: "Розваги",
      mood: "Пригодницьке",
      budget: "1000+ грн",
      duration: "2–3 години"
    ...
    {
      title: "🕹️ Турнір для двох",
      description: "Виберіть кілька ігор та влаштуйте особистий турнір.",
      place: "Розваги",
      mood: "Веселе",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎟️ Культурне побачення",
      description: "Відвідайте виставу, концерт або іншу подію, яка вам обом цікава.",
      place: "Розваги",
      mood: "Романтичне",
      budget: "1000+ грн",
      duration: "3+ години"
    ...
    {
      title: "🎳 Хто програв — виконує бажання",
      description: "Грайте в боулінг, а переможець отримує право загадати маленьке бажання.",
      place: "Розваги",
      mood: "Веселе",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎮 Парне змагання",
      description: "Знайдіть гру для двох і визначте, хто переможе.",
      place: "Розваги",
      mood: "Веселе",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "🧑‍🎨 Творче побачення",
      description: "Разом створіть щось, що залишиться вам на пам'ять.",
      place: "Розваги",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎟️ Вечір подій",
      description: "Знайдіть цікаву подію у місті та вирушайте туди без довгого планування.",
      place: "Розваги",
      mood: "Пригодницьке",
      budget: "1000+ грн",
      duration: "3+ години"
    ...
    {
      title: "🏆 Наш чемпіонат",
      description: "Влаштуйте серію маленьких змагань і визначте переможця вечора.",
      place: "Розваги",
      mood: "Веселе",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    // 🌹 ДУЖЕ РОМАНТИЧНІ — 15
    {
      title: "💌 100 причин, чому я тебе люблю",
      description: "Разом або окремо напишіть по 100 причин, чому любите одне одного.",
      place: "Сюрприз",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "3+ години"
    ...
    {
      title: "🌹 Побачення з букетом",
      description: "Подаруйте коханій букет без особливого приводу та проведіть вечір разом.",
      place: "Сюрприз",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "2–3 години"
    ...
    {
      title: "💍 Особливий вечір",
      description: "Красивий одяг, романтична атмосфера, вечеря та багато теплих слів.",
      place: "Сюрприз",
      mood: "Романтичне",
      budget: "1000+ грн",
      duration: "3+ години"
    ...
    {
      title: "🕯️ Свічки та любовні листи",
      description: "Запаліть свічки та прочитайте одне одному заздалегідь написані листи.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    {
      title: "🎁 Побачення-сюрприз",
      description: "Один партнер повністю організовує вечір, а інший нічого не знає до останнього моменту.",
      place: "Сюрприз",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "3+ години"
    ...
    {
      title: "🌹 Троянда + записка",
      description: "Подаруйте троянду з маленькою запискою та вирушайте разом на прогулянку.",
      place: "Сюрприз",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "❤️ Наш вечір спогадів",
      description: "Згадайте день вашого знайомства, перше побачення та найкращі моменти.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "💗 Побачення з обіцянками",
      description: "Напишіть одне одному по 5 маленьких обіцянок на майбутнє.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "📦 Коробка спогадів",
      description: "Почніть створювати коробку з вашими фотографіями, записками та маленькими пам'ятними речами.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "2–3 години"
    ...
    {
      title: "🌙 Побачення під зорями",
      description: "Знайдіть безпечне місце, де можна спокійно подивитися на нічне небо.",
      place: "На вулиці",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "💐 Квіти без приводу",
      description: "Подаруйте квіти просто тому, що сьогодні хочеться зробити коханій приємно.",
      place: "Сюрприз",
      mood: "Романтичне",
      budget: "300–600 грн",
      duration: "1–2 години"
    ...
    {
      title: "💌 Відкрий, коли...",
      description: "Підготуйте серію маленьких конвертів із написами «Відкрий, коли сумно», «Відкрий, коли скучила» тощо.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "2–3 години"
    ...
    {
      title: "💕 Наш список мрій",
      description: "Створіть великий список місць і речей, які хочете здійснити разом.",
      place: "Вдома",
      mood: "Романтичне",
      budget: "До 300 грн",
      duration: "1–2 години"
    ...
    {
      title: "💖 День тільки для нас",
      description: "Повністю присвятіть день одне одному без зайвих справ та поспіху.",
      place: "Сюрприз",
      mood: "Романтичне",
      budget: "600–1000 грн",
      duration: "3+ години"
    },
    {
      ...
      description: "Уявіть, що сьогодні ви король і королева: красивий одяг, особлива вечеря та максимум турботи.",
      place: "Сюрприз",
      mood: "Романтичне",
      budget: "1000+ грн",
      duration: "3+ години"
  ...
  function generateDate() {
    ...
    let availableDates = filteredDates;

    // Якщо є кілька варіантів — намагаємося не показувати
    // те саме побачення двічі поспіль
    if (currentDate && filteredDates.length > 1) {
      availableDates = filteredDates.filter(
        (date) => date.title !== currentDate.title
      );
    }
    ...
    setCurrentDate(availableDates[randomIndex]);
  }
  ...
  return (
    <div style={styles.page}>
      ...
      >
        ...
        >
          100 ідей для ваших особливих моментів ❤️
        </p>
      </div>
      ...
      >
        ...
        >
          🔎 Знайдено: <b>{filteredDates.length}</b> побачень
        </div>
      </div>
      ...
      {filteredDates.length === 0 && (
        ...
        >
          ...
          <h3>
            Немає побачень за такими фільтрами
          </h3>

          <p>
            Спробуйте змінити один із параметрів ❤️
          </p>
