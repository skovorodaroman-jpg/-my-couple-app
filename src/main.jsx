                    ...
                    <>
                        ...
                        <div className="grid">
                            ...
                            >
                                <CalendarDays />
                                <b>{events[0].days}</b>
                                <span>днів до події</span>
                            </button>

                            <button
                                className="card tile"
                                onClick={() => setMiss(true)}
                            >
                                <Heart />
                                <b>🥺</b>
                                <span>Я сумую</span>
